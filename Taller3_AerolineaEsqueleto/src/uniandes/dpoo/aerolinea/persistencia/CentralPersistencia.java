...
public class CentralPersistencia
{
    ...
    public static IPersistenciaAerolinea getPersistenciaAerolinea(String tipoArchivo) throws TipoInvalidoException {
        if ("json".equalsIgnoreCase(tipoArchivo)) {
            // Retorna una instancia de PersistenciaAerolineaJson para archivos JSON
            return new PersistenciaAerolineaJson();
        } else if ("plaintext".equalsIgnoreCase(tipoArchivo)) {
            // Retorna una instancia de PersistenciaAerolineaPlaintext para archivos de texto plano
            return new PersistenciaAerolineaPlaintext();
        } else {
            // Lanza una excepción si el tipo de archivo no es válido
